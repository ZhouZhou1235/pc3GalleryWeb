...
import { faFeather, faImage } from '@fortawesome/free-solid-svg-icons';
</script>
            ...
            <div class="col-sm-6 p-3">
                ...
                <form @submit.prevent="addGallery()">
                    <div class="input-group">
                        ...
                        <input type="file" class="form-control" id="theImageFile" :onchange="showImg" v-on:change="theFileReady($event)">
                    </div>
                    <div class="input-group">
                        <div class="input-group-text">
    ...
    export default {
        ...
        methods: {
            theFileReady(event){
                ...
                fileMover.fileReady(event,this.formAddGallery);
            },
            addGallery(){
                // 上传画廊
                let fileMover = new FileMover();
                fileMover.fileUpload(this.formAddGallery);
            }
        },
        mounted(){
            { // 是否登录
